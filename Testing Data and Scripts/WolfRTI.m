...
w = 1:200*pi; % generate frequency list
...
figure(1)
plot(w./(100*pi),b);xlabel('Frequency 100\pi [Hz]');ylabel('Acceleration [Gs]');%legend('Absolute acceleration','Relative acceleration (Gs)');
figure(2)
